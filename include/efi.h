...
#define TRUE  ((efi_boolean_t)(1==1))

#define FALSE ((efi_boolean_t)(0==1))
...
typedef packed_guid_t efi_packed_guid_t;
...
{
  efi_status_t EFIAPI (*create_child) (struct efi_service_binding *this,
                                       efi_handle_t *child_handle);
  efi_status_t EFIAPI (*destroy_child) (struct efi_service_binding *this,
                                        efi_handle_t *child_handle);
...
struct efi_shim_lock_protocol
{
  efi_status_t EFIAPI (*verify) (void *buffer, uint32_t size);
};
typedef struct efi_shim_lock_protocol efi_shim_lock_protocol_t;

typedef efi_guid_t efi_rng_algorithm_t;

struct efi_rng_protocol
{
  efi_status_t EFIAPI (*get_info) (struct efi_rng_protocol *this,
                                   efi_uintn_t *rng_algorithm_list_size,
                                   efi_rng_algorithm_t *rng_algorithm_list);
  efi_status_t EFIAPI (*get_rng) (struct efi_rng_protocol *this,
                                  efi_rng_algorithm_t *rng_algorithm,
                                  efi_uintn_t rng_value_length,
                                  efi_uint8_t *rng_value);
};
...
typedef struct efi_console_control_protocol efi_console_control_protocol_t;
...
struct efi_gop
{
  efi_status_t EFIAPI (*query_mode) (struct efi_gop *this,
                                     efi_uint32_t mode_number,
                                     efi_uintn_t *size_of_info,
                                     struct efi_gop_mode_info **info);
  efi_status_t EFIAPI (*set_mode) (struct efi_gop *this,
                                   efi_uint32_t mode_number);
  efi_status_t EFIAPI (*blt) (struct efi_gop *this,
                              void *buffer, efi_uintn_t operation,
                              efi_uintn_t sx, efi_uintn_t sy,
                              efi_uintn_t dx, efi_uintn_t dy,
                              efi_uintn_t width, efi_uintn_t height,
                              efi_uintn_t delta);
...
{
  efi_uint64_t revision;
  efi_status_t EFIAPI (*file_open) (struct efi_file_protocol *this,
                                    struct efi_file_protocol **new_handle,
                                    efi_char16_t *file_name,
                                    efi_uint64_t open_mode,
                                    efi_uint64_t attributes);
  efi_status_t EFIAPI (*file_close) (struct efi_file_protocol *this);
  efi_status_t EFIAPI (*file_delete) (struct efi_file_protocol *this);
  efi_status_t EFIAPI (*file_read) (struct efi_file_protocol *this,
                                    efi_uintn_t *buffer_size,
                                    void *buffer);
  efi_status_t EFIAPI (*file_write) (struct efi_file_protocol *this,
                                     efi_uintn_t *buffer_size,
                                     void *buffer);
  efi_status_t EFIAPI (*get_pos) (struct efi_file_protocol *this,
                                  efi_uint64_t *pos);
  efi_status_t EFIAPI (*set_pos) (struct efi_file_protocol *this,
                                  efi_uint64_t pos);
  efi_status_t EFIAPI (*get_info) (struct efi_file_protocol *this,
                                   efi_guid_t *information_type,
                                   efi_uintn_t *buffer_size,
                                   void *buffer);
  efi_status_t EFIAPI (*set_info) (struct efi_file_protocol *this,
                                   efi_guid_t *information_type,
                                   efi_uintn_t buffer_size,
                                   void *buffer);
  efi_status_t EFIAPI (*flush) (struct efi_file_protocol *this);
  efi_status_t EFIAPI (*open_ex) (struct efi_file_protocol *this,
                                  struct efi_file_protocol **new_handle,
                                  efi_char16_t *file_name,
                                  efi_uint64_t open_mode,
                                  efi_uint64_t attributes,
                                  efi_file_io_token_t *token);
  efi_status_t EFIAPI (*read_ex) (struct efi_file_protocol *this,
                                  efi_file_io_token_t *token);
  efi_status_t EFIAPI (*write_ex) (struct efi_file_protocol *this,
                                   efi_file_io_token_t *token);
  efi_status_t EFIAPI (*flush_ex) (struct efi_file_protocol *this,
                                   efi_file_io_token_t *token);
};
typedef struct efi_file_protocol efi_file_protocol_t;
typedef efi_file_protocol_t *efi_file_handle_t;
typedef efi_file_protocol_t  efi_file_t;

#define EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_REVISION 0x00010000
#define EFI_FILE_IO_REVISION  EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_REVISION

struct efi_simple_fs_protocol
{
  efi_uint64_t revision;
  efi_status_t EFIAPI (*open_volume) (struct efi_simple_fs_protocol *this,
                                      efi_file_protocol_t **root);
};
typedef struct efi_simple_fs_protocol efi_simple_fs_protocol_t;
...
typedef struct efi_file_system_info
{
  efi_uint64_t size;
  efi_boolean_t read_only;
  efi_uint64_t volume_size;
  efi_uint64_t free_space;
  efi_uint32_t block_size;
