...
extern void efi_free_pages (efi_physical_address_t address, efi_uintn_t pages);
extern efi_uintn_t efi_find_mmap_size (void);
extern int
...
extern void efi_mm_init (void);
extern void efi_mm_fini (void);
...
extern efi_device_path_protocol_t*
